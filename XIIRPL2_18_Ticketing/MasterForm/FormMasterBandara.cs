...
namespace XIIRPL2_18_Ticketing.MasterForm
{
    public partial class FormMasterBandara : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.conn.Open();
                String sql = "INSERT INTO db_ticket_xii_rpl1_18.tbl_bandara" +
                    "(nama,kodeiata,kota,negaraid,jumlahterminal,alamat)" +
                    "VALUES" +
                    "('" + textnama.Text + "','" + textIata.Text + "'," +
                    "'" + textkota.Text + "','" + textNegara.Text + "'," +
                    "'" + textTerminal.Text + "','" + textAlamat.Text + "')";
